...
import { getIceFactory, updateIceFactory, IceFactory } from "../../database/IceDB";
...
const EditIce = ({ navigation }: { navigation: any }) => {
  ...
  const handleSave = async () => {
    ...
    setSaving(true); 
    const success = await updateIceFactory(factory.id, factory.name, factory.phoneNumber, factory.quantity, factory.googlemap);
    setSaving(false);
